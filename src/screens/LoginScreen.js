...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: '#F5E0C3', // Nude background
    alignItems: 'center',
  ...
  appName: {
    ...
    fontWeight: 'bold',
    marginBottom: 20,
    color: '#333', // Darker color for contrast on nude background
  },
  inputContainer: {
    width: '100%',
  ...
  loginButton: {
    width: '100%',
    backgroundColor: '#5B3A29', // Purple color for login button
    borderRadius: 10,
    paddingVertical: 15,
    alignItems: 'center',
    marginBottom: 20,
